...
Στην περίπτωση μας χρησιμοποιήθηκε η έκδοση https://huggingface.co/ilsp/Meltemi-7B-Instruct-v1-GGUF. Το μοντέλο φορτώθηκε και αρχικά δοκιμάστηκε μέσω του περιβάλλοντος web-gui, ενώ στην συνέχεια χρησιμοποιήθηκε το api μέσω της εφαρμογής του app inventor. Μέσω αρκετών πειραματισμών καταλήξαμε στη καταλληλότερη ρύθμιση βάση και των δυνατοτήτων. Το αποτέλεσμα κρίνεται σχετικά ικανοποιητικό για πειραματική χρήση.
