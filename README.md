...
- Αρχικά οι δοκιμές του meltemi έγιναν σε ένα laptop με χαρακτηριστικά i5-7200U 16GB RAM. Αφού ενεργοποιήθηκε το webui και ρυθμίστηκε το μοντέλο έγιναν δοκιμές μέσω του web περιβάλλοντος. Μετά από διάφορες τροποποιήσεις στην παραμετροποίηση και στην δοκιμή των δύο εκδόσεων των μοντέλων gguf του meltemi, προτιμήθηκε το meltemi-instruct-v1_q5_K_M.bin καθώς το meltemi-instruct-v1_q3_K_M.bin παρουσίαζε διάφορες δυσλειτουργίες ενώ το μέγεθος του meltemi-instruct-v1_q5_K_M.bin δεν θεωρήθηκε απαγορευτικό.
